...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="story" class="story section_animation">
            <h2>
                <span class="title_animation">L'</span>
                <span class="title_animation">histoire</span>
            </h2>
            ...
            <article id="characters">
                <div class="main-character">
                    <h3>
                        <span class="title_animation">Les</span>
                        <span class="title_animation">personnages</span>
                    </h3>
                    <?php
            ...
            <article id="place">
                <div>
                    <h3>
                        <span class="title_animation">Le</span>
                        <span class="title_animation">lieu</span>
                    </h3>
        ...
        <section id="studio" class="studio section animation">
            <h2>
                <span class="title_animation">Studio</span>
                <span class="title_animation">Koukaki</span>
            </h2>
            <div>
